...
{
    public class EfColorRegisterDal : RepositoryDal<ColorRegister>, IRepositoryDal<ColorRegister>,IColorRegisterDal
    {
        public EfColorRegisterDal(EShopperDbContext context) : base(context)
        {
        }
    }
}
