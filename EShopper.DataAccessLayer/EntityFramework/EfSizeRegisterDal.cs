...
{
    public class EfSizeRegisterDal : RepositoryDal<SizeRegister>, IRepositoryDal<SizeRegister>,ISizeRegisterDal
    {
        private readonly EShopperDbContext _context;
        public EfSizeRegisterDal(EShopperDbContext context) : base(context)
        {
            _context = context;
        }
