...
{
    public class EfSubscribeDal : RepositoryDal<Subscribe>, IRepositoryDal<Subscribe>, ISubscribeDal
    {
        public EfSubscribeDal(EShopperDbContext context) : base(context)
        {
        }
    }
}
