        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecurtyNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentRegisters_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ColorRegisters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ColorRegisters_Colors_ColorId",
                        column: x => x.ColorId,
                        principalTable: "Colors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ColorRegisters_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CouponCodes_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SizeRegisters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SizeRegisters_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SizeRegisters_Sizes_SizeId",
                        column: x => x.SizeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ColorRegisters_ColorId",
                table: "ColorRegisters",
                column: "ColorId");

            migrationBuilder.CreateIndex(
                name: "IX_ColorRegisters_ProductId",
                table: "ColorRegisters",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CouponCodes_ProductId",
                table: "CouponCodes",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentRegisters_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SizeRegisters_ProductId",
                table: "SizeRegisters",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SizeRegisters_SizeId",
                table: "SizeRegisters",
                column: "SizeId");
